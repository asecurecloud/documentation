...
- Create a new workload : Requires at least one assessment created (if not, create one following the steps [here](/gettingStarted))

- Pull down an existing workload : Needs to be created in the Well-Architected Tool first
