...
<div
  style={{ backgroundColor: "#e6ffe6", padding: "10px", borderRadius: "4px" }}
>
  ASecureCloud is an [AWS-validated
  partner](https://aws.amazon.com/well-architected-tool/partners/) that
  integrates with the Well-Architected Tool.
</div>
