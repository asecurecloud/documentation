...
The profile settings are used to manage the user's preferences and settings. Its organized in the following sections:
...
This section alllows you to define a custom report using the existing assessment rules for a better fit to your own compliance requirements and environment. 
